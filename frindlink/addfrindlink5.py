...
time.sleep(3)
driver.find_element_by_id("name").send_keys("名称")
driver.find_element_by_id("url").send_keys("http://www.baidu.com")
driver.find_element_by_id("rank").send_keys("1")
driver.find_element_by_xpath(".//*[@id='nofollow']").click()
driver.find_element_by_xpath("//*[@id='nofollow']/option[2]").click()
driver.find_element_by_xpath(".//*[@id='addModal']/div/div/div[3]/button[2]").click()
t1=driver.find_element_by_xpath(".//*[@id='Tr10']/td[1]").text
t2=driver.find_element_by_xpath(".//*[@id='Tr10']/td[2]").text
